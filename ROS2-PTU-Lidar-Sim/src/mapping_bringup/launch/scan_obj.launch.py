...
+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=
 +File name: scan_obj.launch.py
 +Description: Launch file to scan OBJ models in a simulated Gazebo environment.
...
def generate_launch_description():
    ...
    # Load World to scan
    file = os.path.join(pkg_project_mapping_custom_description, 'models', 'obj', 'model.sdf')
