 ...
 *
 */
#ifndef GZ_SIM_SYSTEMS_JOINTPOSITIONCONTROLLERMOD_HH_
#define GZ_SIM_SYSTEMS_JOINTPOSITIONCONTROLLERMOD_HH_
...
{
  // Forward declaration
  class JointPositionControllerModPrivate;
  ...
  /// The default value is 0.
  class JointPositionControllerMod
      : public System,
        public ISystemConfigure,
        public ISystemPreUpdate
  {
    /// \brief Constructor
    public: JointPositionControllerMod();

    /// \brief Destructor
    public: ~JointPositionControllerMod() override = default;
    ...
    private: std::unique_ptr<JointPositionControllerModPrivate> dataPtr;
  };
  }
}
}
