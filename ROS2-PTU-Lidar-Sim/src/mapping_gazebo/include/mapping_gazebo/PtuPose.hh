#ifndef GZ_SIM_SYSTEMS_PTUPOSE_HH_
#define GZ_SIM_SYSTEMS_PTUPOSE_HH_
...
namespace systems
{
        ...
        public ISystemPreUpdate
  {
    ...
    /// \brief Destructor
    public: ~PtuPose() override = default;
    ...
    private: std::unique_ptr<PtuPosePrivate> dataPtr;
  };
  }
}
}
